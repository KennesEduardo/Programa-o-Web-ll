// scrips do index.html
// Headers
let poster = document.querySelector("header .poster img").setAttribute('src', bd.fotoPoster);
...
for (let temporada of bd.temporadas){
    ...
    <div class="temporada">
        ...
        <div class="info">
            ...
            <a href="#" class="botao" id="btn-${n}">Ver episódio</a>
